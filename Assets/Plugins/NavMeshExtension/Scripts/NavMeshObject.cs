...
public class NavMeshObject : MonoBehaviour
{
    ...
    public void Combine()
    {
        ...
        */
        ...
        for (int i = 0; i < duplicates.Count; i++)
        {
            ...
            List<int> indices = vertices.Select((value, index) => new { value, index })
                      .Where(a => Equals(a.value, duplicates[i]))
        ...
        */
        ...
        var o_197_12_636265379468186360 = myFilter.sharedMesh;
    }
    ...
    public void DeletePoint()
    {
        ...
        {
            current.Clear();
            subPoints[subPoints.Count - 1].list.Clear();
            list.Clear();
        }
        else
        {
            current.RemoveAt(current.Count - 1);
            subPoints[subPoints.Count - 1].list.RemoveAt(current.Count - 1);
